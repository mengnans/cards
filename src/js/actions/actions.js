import {TOGGLE_DRAWER, PAGE_CHANGE, INITIAL_LOAD, RE_LOAD} from "../constants/action-types";
...
export const reLoad = (page, dataPerPage) => ({ type: RE_LOAD,  payload: get(BACKEND_URL,generateUrlParams(page, dataPerPage))});
